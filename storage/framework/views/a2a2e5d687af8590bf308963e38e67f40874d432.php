...
<div class="container detail-section-2">
   <div class="row">
      ...
      <div class="col-lg-5 col-md-5 col-sm-6 col-12">
         <img src="<?php echo e(asset('public/upload/images/menu_item_icon/'.$itemdetails->menu_image)); ?>" class="img-fluid detail-product-img" alt="<?php echo e(__('messages.res_image')); ?>">
      </div>
            ...
            <div class="bor detail-related-tab">
               <div class="items">
                  <div class="b-img">
                     ...
                     <img src="<?php echo e(asset('public/upload/images/menu_item_icon/'.$related_item[$i]->menu_image)); ?>" class="img-fluid">
                     </a>
                  </div>
                  <div class="bor">
                     <div class="b-text">
...
<?php echo $__env->make('user.subindex', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RestaurantWebsite\resources\views/user/detailitem.blade.php ENDPATH**/ ?>