...
<html>
   <head>
      ...
      <?php if(__('messages.rtl')=='0'): ?>
         <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/burger/css/style.css')); ?>">
      <?php else: ?>
         <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/burger/css/rtl.css')); ?>">
      <?php endif; ?>

      <link rel='stylesheet' href='https://cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.7.1/slick.css'>
      <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
      <script type="text/javascript" src="<?php echo e(asset('public/burger/js/bootstrap.min.js')); ?>"></script>
      <link rel="stylesheet" type="text/css" href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
      <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/burger/css/app.css')); ?>"/>
      <link rel="stylesheet" href="<?php echo e(asset('public/burger/css/font.css')); ?>">
      ...
      <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/burger/css/bootstrap.min.css')); ?>">
      <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js"></script>
     
     
      <script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"></script>
      <script type="text/javascript" src="<?php echo e(asset('public/burger/js/dropdown.js')); ?>"></script>
      ...
      <script type="text/javascript" src="<?php echo e(asset('public/burger/js/jquery.mixitup.min.js')); ?>"></script>
                     ...
                     <div class="login-modal" id="loginmodel">
                        ...
                        <div class="tab-content">
                           <div id="tab1" class="tab-pane show active">
                              ...
                              <input type="text" required name="phone" class="form-control" id="modal-login-phone" placeholder="<?php echo e(__('messages.phone_no')); ?>" value="<?php echo e(isset($_COOKIE['phone'])?$_COOKIE['phone']:''); ?>">
                              <label class="for_button_value">
                              <?php echo e(__('messages.password')); ?>

                              <span class="requiredfield">*</span>
                              </label>
                              <input type="password" required name="password" class="form-control" id="modal-login-password" placeholder="<?php echo e(__('messages.password')); ?>" value="<?php echo e(isset($_COOKIE['password'])?$_COOKIE['password']:''); ?>">
                              <div class="modal-re">
                           ...
                           <div id="tab2" class="tab-pane ">
                              ...
                              <form action="<?php echo e(url('userregister')); ?>" method="post">
                                 ...
                                 <input type="text" required name="name" class="form-control" id="modal-name" placeholder="<?php echo e(__('messages.name')); ?>">
                                 <label class="for_button_value">
                                 <?php echo e(__('messages.email')); ?>

                                 <span class="requiredfield">*</span>
                                 </label>
                                 <input type="text" required name="email" class="form-control" id="modal-email" placeholder="<?php echo e(__('messages.email')); ?>">
                                 <label class="for_button_value">
                                 <?php echo e(__('messages.phone_no')); ?>

                                 <span class="requiredfield">*</span>
                                 </label>
                                 <input type="text" required name="phone_reg" class="form-control" id="modal-phone" placeholder="<?php echo e(__('messages.phone_no')); ?>">
                                 <label class="for_button_value">
                                 <?php echo e(__('messages.password')); ?>

                                 <span class="requiredfield">*</span>
                                 </label>
                                 <input type="password" required name="password_reg" class="form-control" id="modal-password" placeholder="<?php echo e(__('messages.password')); ?>">
                                 <label class="for_button_value">
                                 <?php echo e(__('messages.confirm_pwd')); ?>

                                 <span sclass="requiredfield">*</span>
                                 </label>
                                 <input type="password" required name="con_password_reg" class="form-control" id="modal-cpassword" placeholder="<?php echo e(__('messages.confirm_pwd')); ?>" onchange="checkboth(this.value)">
         ...
         <div class="modal-dialog modal-1">
            ...
            <div class="empty-box">
               <div class="modal-header cart-h">
                  <button type="button" class="close" data-dismiss="modal">
                  <img src='<?php echo e(asset("public/burger/images/close.png")); ?>'>
                  </button>
               </div>
               <div class="container">
                  <div class="cart-modal-empty col-md-8">
                     <img src='<?php echo e(asset("public/burger/images/empty-cart.png")); ?>'>
            ...
            <div class="modal-content">
               ...
               <div class="container">
                  <div class="cart-modal col-md-8">
                           ...
                           <div class="b-text">
                              <div class="box-spa">
                                 ...
                                 <p><?php echo e($item->quantity); ?>
                                    ...
                                    <img src="<?php echo e(asset('public/burger/images/cross.png')); ?>">
                     ...
                     <div class="last-box">
                        <div class="Delivery">
                           <img src="<?php echo e(asset('public/burger/images/delivery.png')); ?>" style="width:50px">
                        </div>
                        <div class="last-text">
      ...
      <div class="container">
         <div class="portfolist_sb_b" id="portfoliolist">
            <div class="row">
               ...
               <div class="portfolio <?php echo e($it->categoryitem->id); ?> col-md-6 public/burger w3-container  w3-animate-zoom portfoliocat" data-cat="<?php echo e($it->categoryitem->id); ?>" data-bound>
                  <div class="items">
                     <div class="b-img">
               ...
               <div class="col-md-6 text-box">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-5 col-sm-5 col-5 google">
                        <a href="<?php echo e(Session::get('playstore')); ?>" target="_blank"><img src="<?php echo e(asset('public/burger/images/Google-Play-icon.png')); ?>" class="img-fluid"></a>
                     </div>
                     <?php endif; ?>
                     <?php if($setting->have_appstore=='1'): ?>
                     <div class="col-md-5 col-sm-5 col-5 apple">
                        <a href="<?php echo e(Session::get('appstore')); ?>" target="_blank"><img src="<?php echo e(asset('public/burger/images/App-Store-icon.png')); ?>" class="img-fluid"></a>
                     </div>
                     <?php endif; ?>
                  </div>
               ...
               <div class="row">
                  ...
                  <div class="col-md-3 info">
                     ...
                     <div class="f-location">
                        <img src="<?php echo e(asset('public/burger/images/location.png')); ?>">
                     </div>
                     <span>
                     ...
                     <div class="f-location">
                        <img src="<?php echo e(asset('public/burger/images/phone.png')); ?>">
                     </div>
                     <span>
                     ...
                     <div class="f-location">
                        <img src="<?php echo e(asset('public/burger/images/email.png')); ?>">
                     </div>
                     <span>
               ...
               <div class="container">
                  <div class="row">
                     ...
                     <div class="col-md-6 v-box">
                        <div class="v-img">
                           <a href="#"><img src="<?php echo e(asset('public/burger/images/v-1.png')); ?>"></a>
                        </div>
                        <div class="v-img">
                           <a href="#"><img src="<?php echo e(asset('public/burger/images/v-2.png')); ?>"></a>
                        </div>
                        <div class="v-img">
                           <a href="#"><img src="<?php echo e(asset('public/burger/images/v-3.png')); ?>"></a>
                        </div>
                        <div class="v-img">
                           <a href="#"><img src="<?php echo e(asset('public/burger/images/v-4.png')); ?>"></a>
                        </div>
                        <div class="v-img">
                           <a href="#"><img src="<?php echo e(asset('public/burger/images/v-5.png')); ?>"></a>
                        </div>
                     </div>
                  </div>
               </div>
   ...
   <script src="<?php echo e(URL::to('public\js\lib\owl-carousel\owl.carousel.min.js')); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\RestaurantWebsite\resources\views/user/index.blade.php ENDPATH**/ ?>