                     ...
                     <div class="collapse <?php echo e($showsec); ?> " id="collapseTH">
                        <div class="cashswipe">
                           <div class="radio check">
                              ...
                              <img id="pay1" onclick="changebutton('Cash')" src="<?php echo e(asset('public/burger/images/5.png')); ?>"/>
                           </div>
                           ...
                           <div class="check">
                              ...
                              <img id="pay2" onclick="changebutton('Paypal')" src="<?php echo e(asset('public/burger/images/1.png')); ?>"/>
                           </div>
                           <?php endif; ?>
                           ...
                           <div class="check">
                              ...
                              <img id="pay3" onclick="changebutton('Stripe')" src="<?php echo e(asset('public/burger/images/2.png')); ?>"/>
                           </div>
                           <?php endif; ?>
                        </div>
                     </div>
               ...
               <div id="orderplacestrip">
                  <form action="<?php echo e(url('make-payment')); ?>" method="POST">
                     ...
                     <script
                        ...
                        data-description=""
                        data-image="<?php echo e(asset('public/burger/images/unnamed.jpg')); ?>"
...
<?php echo $__env->make('user.subindex', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RestaurantWebsite\resources\views/user/checkout.blade.php ENDPATH**/ ?>