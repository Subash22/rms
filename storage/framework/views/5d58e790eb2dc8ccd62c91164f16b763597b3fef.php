...
<html>
   <head>
      ...
      <link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
         ...
         <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/burger/css/style.css').'?version=232132'); ?>">
         <?php else: ?>
            <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/burger/css/rtl.css').'?version=56565'); ?>">
         <?php endif; ?>
                        ...
                        <div class="portfolio por-1 col-md-12 row">
                           ...
                           <div class="b-text">
                              <div class="box-spa">
                                 ...
                                 <p><?php echo e($item->quantity); ?> <img src="<?php echo e(asset('public/burger/images/cross.png')); ?>"> <?php echo e(Session::get("usercurrency").number_format($item->price, 2, '.', '')); ?>
               ...
               <div class="container">
                  <div class="row">
                     ...
                     <div class="col-md-6 v-box">
                        <div class="v-img">
                           <a ><img src="<?php echo e(asset('public/burger/images/v-1.png')); ?>"></a>
                        </div>
                        <div class="v-img">
                           <a ><img src="<?php echo e(asset('public/burger/images/v-2.png')); ?>"></a>
                        </div>
                        <div class="v-img">
                           <a ><img src="<?php echo e(asset('public/burger/images/v-3.png')); ?>"></a>
                        </div>
                        <div class="v-img">
                           <a ><img src="<?php echo e(asset('public/burger/images/v-4.png')); ?>"></a>
                        </div>
                        <div class="v-img">
                           <a ><img src="<?php echo e(asset('public/burger/images/v-5.png')); ?>"></a>
                        </div>
                     </div>
                  </div>
               </div>
...
</html><?php /**PATH C:\xampp\htdocs\RestaurantWebsite\resources\views/user/subindex.blade.php ENDPATH**/ ?>