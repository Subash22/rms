               ...
               <ul class="nav nav-pills flex-column" id="myTab" role="tablist">
                  <li class="nav-item">
                     <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">
                        ...
                        <img src="<?php echo e(asset('public/burger/images/tab-1.png')); ?>" class="acc-tab-icon">
                        </span>
                  ...
                  <li class="nav-item">
                     <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">
                        <span class="account-tabimg">
                        <img src="<?php echo e(asset('public/burger/images/tab-2.png')); ?>" class="acc-tab-icon">
                        </span>
                  ...
                  <li class="nav-item">
                     <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false">
                        <span class="account-tabimg">
                        <img src="<?php echo e(asset('public/burger/images/tab-3.png')); ?>" class="acc-tab-icon">
                        </span>
                  ...
                  <li class="nav-item log">
                     <a class="nav-link" data-toggle="modal" data-target="#myModal2" href="#logout" role="tab">
                        <span class="account-tabimg">
                        <img src="<?php echo e(asset('public/burger/images/tab-4.png')); ?>" class="acc-tab-icon">
                        </span>
...
<?php echo $__env->make('user.subindex', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RestaurantWebsite\resources\views/user/myaccount.blade.php ENDPATH**/ ?>