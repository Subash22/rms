          ...
          <div class="row">
              <div class="col-lg-8 col-md-8">
               ...
               <div class="col-lg-4 col-md-4">
                <img src="<?php echo e(asset('public/burger/images/burger-1.png')); ?>" class="about-image-1">
               </div>
          </div>
      </div>
      <div class="row">
              <div class="col-lg-4 col-md-4">
                  <img src="<?php echo e(asset('public/burger/images/davis_burger_fries.jpg')); ?>" width="100%">
              </div>
              <div class="col-lg-8 col-md-8">
                    <div class="about-content-1">
...
<?php echo $__env->make('user.subindex', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RestaurantWebsite\resources\views/user/about.blade.php ENDPATH**/ ?>