    ...
    <body style="margin-top:25px">
        <div class="col-md-12" style="float:left;width:100%">
             <div class="col-md-6" style="float:left;">
                 <img src="<?php echo e(asset('public/upload/web').'/'.$data['admin']->logo); ?>" style="width:100px;height:100px;" />
             </div>
...
<?php /**PATH C:\xampp\htdocs\RestaurantWebsite\resources\views/admin/print.blade.php ENDPATH**/ ?>