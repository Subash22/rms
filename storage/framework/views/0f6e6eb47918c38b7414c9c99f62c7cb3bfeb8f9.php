      ...
      <div div class="order-status">
         <ul>
            <li class="process-1">
               <div class="pro-rou">
                  <div class="round-d">
                     <img src="<?php echo e(asset('public/burger/images/ture.png')); ?>">
                  </div>
               </div>
                  ...
                  <div class="sub-order">
                     ...
                     <div class="sub-order-1">
                        <div class="img">
                           ...
                           <img src="<?php echo e(asset('public/upload/images/menu_item_icon/'.$as->menu_image)); ?>">
                             <?php endif; ?>
                        ...
                        <div class="sub-order-text">
                           ...
                           <span>
                              ...
                              <h1><?php echo e(Session::get("usercurrency")); ?>   	         		<?php echo e($item->item_amt); ?><img src="<?php echo e(asset('public/burger/images/cross-1.png')); ?>"><?php echo e($item->item_qty); ?></h1>
                           </span>
                        </div>
                     </div>
                     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('user.subindex', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RestaurantWebsite\resources\views/user/viewdetails.blade.php ENDPATH**/ ?>