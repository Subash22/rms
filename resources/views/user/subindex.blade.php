...
<html>
   <head>
      ...
      <link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
         ...
         <link rel="stylesheet" type="text/css" href="{{asset('public/burger/css/style.css').'?version=232132'}}">
         @else
            <link rel="stylesheet" type="text/css" href="{{asset('public/burger/css/rtl.css').'?version=56565'}}">
         @endif
                        ...
                        <div class="portfolio por-1 col-md-12 row">
                           ...
                           <div class="b-text">
                              <div class="box-spa">
                                 ...
                                 <p>{{$item->quantity}} <img src="{{asset('public/burger/images/cross.png')}}"> {{Session::get("usercurrency").number_format($item->price, 2, '.', '')}}
                                 </p>
                              </div>
                              <span class="price">
               ...
               <div class="container">
                  <div class="row">
                     ...
                     <div class="col-md-6 v-box">
                        <div class="v-img">
                           <a ><img src="{{asset('public/burger/images/v-1.png')}}"></a>
                        </div>
                        <div class="v-img">
                           <a ><img src="{{asset('public/burger/images/v-2.png')}}"></a>
                        </div>
                        <div class="v-img">
                           <a ><img src="{{asset('public/burger/images/v-3.png')}}"></a>
                        </div>
                        <div class="v-img">
                           <a ><img src="{{asset('public/burger/images/v-4.png')}}"></a>
                        </div>
                        <div class="v-img">
                           <a ><img src="{{asset('public/burger/images/v-5.png')}}"></a>
                        </div>
                     </div>
                  </div>
               </div>
