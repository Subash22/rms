                     ...
                     <div class="collapse {{$showsec}} " id="collapseTH">
                        <div class="cashswipe">
                           <div class="radio check">
                              ...
                              <img id="pay1" onclick="changebutton('Cash')" src="{{asset('public/burger/images/5.png')}}"/>
                           </div>
                           ...
                           <div class="check">
                              ...
                              <img id="pay2" onclick="changebutton('Paypal')" src="{{asset('public/burger/images/1.png')}}"/>
                           </div>
                           @endif
                           ...
                           <div class="check">
                              ...
                              <img id="pay3" onclick="changebutton('Stripe')" src="{{asset('public/burger/images/2.png')}}"/>
                           </div>
                           @endif
                        </div>
                     </div>
               ...
               <div id="orderplacestrip">
                  <form action="{{url('make-payment')}}" method="POST">
                     ...
                     <script
                        ...
                        data-description=""
                        data-image="{{asset('public/burger/images/unnamed.jpg')}}"
