            ...
            <div class="modal-body">
               <form name="menu_form_category" action="{{url('add_menu_cateogry')}}" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                     <label>{{__('messages.category_name')}} <span class="reqfield">*</span></label>
                     <input type="text" class="form-control" placeholder=" {{__('messages.category_name')}}" name="name" required>
                  </div>
                  <div class="form-group">
                     <label>{{__('messages.category_icon')}}(35 X35) <span class="reqfield">*</span></label>
         ...
         <div class="modal-content">
            ...
            <div class="modal-body">
               <form name="menu_form_category" action="{{url('updatecategory')}}" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                     <label>{{__('messages.category_name')}} <span class="reqfield">*</span></label>
                     <input type="text" class="form-control" placeholder="{{__('messages.category_name')}}" name="name" id="name" required>
                  </div>
                  <div class="form-group">
                     <label>{{__('messages.category_icon')}}(35 X35) <span class="reqfield">*</span></label></br>
