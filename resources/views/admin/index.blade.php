...
<html class="no-js" lang="en">
   <head>
      ...
      <link rel="stylesheet" href="{{asset('public/admin_panel/vendors/bootstrap/dist/css/bootstrap.min.css')}}">
      <link rel="stylesheet" href="{{asset('public/admin_panel/vendors/font-awesome/css/font-awesome.min.css')}}">
      <link rel="stylesheet" href="{{asset('public/admin_panel/vendors/themify-icons/css/themify-icons.css')}}">
      <link rel="stylesheet" href="{{asset('public/admin_panel/vendors/flag-icon-css/css/flag-icon.min.css')}}">
      <link rel="stylesheet" href="{{asset('public/admin_panel/vendors/selectFX/css/cs-skin-elastic.css')}}">
      <link rel="stylesheet" href="{{asset('public/admin_panel/vendors/jqvmap/dist/jqvmap.min.css')}}">
      @if(__('messages.rtl')=='0')
         <link rel="stylesheet" href="{{asset('public/admin_panel/assets/css/style.css')}}">
      @else
         <link rel="stylesheet" href="{{asset('public/admin_panel/assets/css/style.css')}}">
         <link rel="stylesheet" href="{{asset('public/admin_panel/assets/css/rtl.css?v=159623')}}">
      @endif

      <link href='https://fonts.googleapis.com/css?family=Open+Sans:400,600,700,800' rel='stylesheet' type='text/css'>
      <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.1/jquery.min.js"></script>
      <script type="text/javascript" src="https://cdn.datatables.net/1.10.8/js/jquery.dataTables.min.js"></script>
      <link rel="stylesheet" href="{{asset('public/admin_panel/vendors/datatables.net-bs4/css/dataTables.bootstrap4.min.css')}}">
      <link rel="stylesheet" href="{{asset('public/admin_panel/vendors/datatables.net-buttons-bs4/css/buttons.bootstrap4.min.css')}}">
   ...
   <body class="rtl">
      ...
      <input type="hidden" id="soundnotify" value="{{asset('RestaurantWebsite/public/sound/notification/notification.mp3')}}">
      ...
      <script src="{{asset('public/admin_panel/vendors/jquery/dist/jquery.min.js')}}"></script>
      <script src="{{asset('public/admin_panel/vendors/popper.js/dist/umd/popper.min.js')}}"></script>
      <script src="{{asset('public/admin_panel/vendors/bootstrap/dist/js/bootstrap.min.js')}}"></script>
      <script src="{{asset('public/admin_panel/assets/js/main.js')}}"></script>
      <script src="{{asset('public/admin_panel/vendors/datatables.net/js/jquery.dataTables.min.js')}}"></script>
      <script src="{{asset('public/admin_panel/vendors/datatables.net-bs4/js/dataTables.bootstrap4.min.js')}}"></script>
      <script src="{{asset('public/admin_panel/vendors/datatables.net-buttons/js/dataTables.buttons.min.js')}}"></script>
      <script src="{{asset('public/admin_panel/vendors/datatables.net-buttons-bs4/js/buttons.bootstrap4.min.js')}}"></script>
      <script src="{{asset('public/admin_panel/vendors/jszip/dist/jszip.min.js')}}"></script>
      <script src="{{asset('public/admin_panel/vendors/pdfmake/build/pdfmake.min.js')}}"></script>
      <script src="{{asset('public/admin_panel/vendors/pdfmake/build/vfs_fonts.js')}}"></script>
      <script src="{{asset('public/admin_panel/vendors/datatables.net-buttons/js/buttons.html5.min.js')}}"></script>
      <script src="{{asset('public/admin_panel/vendors/datatables.net-buttons/js/buttons.print.min.js')}}"></script>
      <script src="{{asset('public/admin_panel/vendors/datatables.net-buttons/js/buttons.colVis.min.js')}}"></script>
      <script src="{{asset('public/admin_panel/assets/js/init-scripts/data-table/datatables-init.js')}}"></script>
